...
const SEM_BAPINHO: Texture2D = preload("res://Sprites/gameplay/Prensas/prensa_redonda_longa.png")
const COM_BAPINHO: Texture2D = preload("res://Sprites/gameplay/Prensas/prensa_redonda_longa_com_o_bapinho.png")
...
func _process(_delta: float) -> void:
	...
	if Input.is_action_pressed("clique") && permite_clique:
		_animation_player.play("PrensarRedondo")
