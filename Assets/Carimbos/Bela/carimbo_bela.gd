...
const SEM_BAPINHO: Texture2D = preload("res://Sprites/gameplay/Carimbos/carimbo_bela_sapo.png")
const COM_BAPINHO: Texture2D = preload("res://Sprites/gameplay/Carimbos/carimbo_bela_sapo_com_bapinho.png")
...
func _process(_delta: float) -> void:
	...
	if Input.is_action_pressed("clique") && permite_clique:
		_animation_player.play("CarimbarBela")
